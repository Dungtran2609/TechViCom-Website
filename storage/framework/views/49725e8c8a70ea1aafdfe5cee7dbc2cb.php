                            ...
                            <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom text-wrap">
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="<?php echo e(asset('admin/images/users/avatar-1.jpg')); ?>" class="img-fluid me-2 avatar-sm rounded-circle" alt="avatar-1">
                                    </div>
                ...
                <div class="dropdown topbar-item">
                    <a type="button" class="topbar-button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle" width="32" src="<?php echo e(asset('admin/images/users/avatar-1.jpg')); ?>" alt="avatar">
                        </span>
                    </a>
...
<?php /**PATH C:\laragon\www\TechViCom_Website_BE\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>