...
unset($__errorArgs, $__bag); ?>" id="description" name="description" rows="3"><?php echo e(old('description', $brand->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            <?php if($brand->image): ?>
                                <div class="mt-3">
                                    ...
                                    <img src="<?php echo e(asset('storage/' . $brand->image)); ?>" width="120" alt="Hình ảnh thương hiệu">
                                </div>
                            <?php endif; ?>
                        </div>
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="1" <?php echo e(old('status', $brand->status) == 1 ? 'selected' : ''); ?>>Hiển thị</option>
                                <option value="0" <?php echo e(old('status', $brand->status) == 0 ? 'selected' : ''); ?>>Ẩn</option>
                            </select>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\TechViCom_Website_BE\resources\views/admin/brands/editBrands.blade.php ENDPATH**/ ?>