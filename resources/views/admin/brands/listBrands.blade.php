...
<div class="container-fluid">
    ...
    <form method="GET" action="{{ route('admin.brands.index') }}" class="mb-4 d-flex gap-2">
                    ...
                    <tbody>
                        ...
                        @foreach ($brands as $brand)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('admin.brands.show', $brand) }}" class="btn btn-light btn-sm" title="Xem chi tiết">
                                            <iconify-icon icon="solar:eye-broken" class="align-middle fs-18"></iconify-icon>
                                        </a>
                                        <a href="{{ route('admin.brands.edit', $brand) }}" class="btn btn-soft-primary btn-sm" title="Chỉnh sửa">
