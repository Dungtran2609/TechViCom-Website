                            ...
                            <tbody>
                                @foreach($brands as $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('admin.products.brands.restore', $brand->brand_id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                            ...
                                            <form action="{{ route('admin.products.brands.force-delete', $brand->brand_id) }}" method="POST"
                                                class="d-inline"
