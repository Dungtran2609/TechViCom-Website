    ...
    public function index()
{
    ...
    return view('admin.brands.listBrands', compact('brands'));
}
    ...
    {
        return view('admin.brands.detailBrand', compact('brand'));
    }
    ...
    public function destroy(Brand $brand)
    {
        ...
        $brand->delete();
        return redirect()->route('admin.brands.index')->with('success', "Thương hiệu với ID $brandId đã được xóa thành công.");
    }
    ...
    public function trashed()
    {
        ...
        return view('admin.brands.trashedBrands', compact('brands'));
    }
    ...
    public function restore($id)
    {
        ...
        $brandId = $brand->brand_id;
        $brand->restore();
        return redirect()->route('admin.brands.trashed')->with('success', "Thương hiệu với ID $brandId đã được khôi phục thành công.");
    }
    ...
    public function forceDelete($id)
    {
        ...
        $brand->forceDelete();
        return redirect()->route('admin.brands.trashed')->with('success', "Thương hiệu với ID $brandId đã được xóa vĩnh viễn.");
    }
